...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/taghazout-car-rental',
    languages: {
  ...
  openGraph: {
    type: 'website',
    url: `${siteUrl}/taghazout-car-rental`,
    siteName: 'AmseelCars',
    locale: 'en_US',
    title: 'Taghazout car rental — From Agadir & airport',
    description:
...
export default function TaghazoutCarRentalPage() {
  const structuredData = generateLocalSeoLandingGraphSchema({
    path: '/taghazout-car-rental',
    name: 'Taghazout car rental — From Agadir & airport',
    description:
      'Rent a car for Taghazout with pickup in Agadir or at Al Massira Airport. SUVs, compacts & premium. Quick booking on WhatsApp.',
    inLanguage: 'en-US',
    breadcrumbItems: [
      { name: 'Home', url: '/' },
      { name: 'Cars', url: '/cars' },
      { name: 'Taghazout car rental', url: '/taghazout-car-rental' },
    ],
    faqs: [...faqs],
    ...
    <>
      ...
      <AgadirLandingShell
        ...
        ctas={[
          ...
          { href: '/agadir-airport-car-rental', label: 'Airport pickup', variant: 'secondary' },
