    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-sm md:text-base text-gray-400 mb-4">Conseils et actualités pour votre location de voiture.</p>
        </motion.div>
      </motion.div>
    </motion.div>
  );
...
export function HomeContent() {
  ...
  useEffect(() => {
    if (isClient) {
      // Simulate loading progress for blog page
      let progress = 0;
  ...
  useEffect(() => {
    return () => {
      // Reset any scroll-related styles when leaving blog page
      if (typeof window !== 'undefined') {
