...
export const cars: Car[] = [
  ...
  ,
  {
    ...
    images: [
      { src: "/images/right-side-troc.webp", alt: "Volkswagen T-Roc - vue avant", isPrimary: true },
  ...
  ,
  {
    ...
    images: [
      { src: "/images/C3 aircross blanche.webp", alt: "Citroën C3 Aircross - vue avant", isPrimary: true },
      { src: "/images/C3 aircross blanche.webp", alt: "Citroën C3 Aircross - intérieur" },
      { src: "/images/C3 aircross blanche.webp", alt: "Citroën C3 Aircross - vue latérale" },
      { src: "/images/C3 aircross blanche.webp", alt: "Citroën C3 Aircross - tableau de bord" },
      { src: "/images/C3 aircross blanche.webp", alt: "Citroën C3 Aircross - détails habitacle" }
    ],
    pricePerDay: 300,
    seats: 5,
    fuelType: "Hybride (mild-hybrid 48V, essence)",
  ...
  ,
  {
    ...
    images: [
      { src: "/images/front-c3-normal.webp", alt: "Citroën C3 - vue avant", isPrimary: true },
      { src: "/images/inside-C3-normal.webp", alt: "Citroën C3 - intérieur" },
      { src: "/images/back-c3-normal.webp", alt: "Citroën C3 - vue latérale" },
      { src: "/images/left-side-c3-normal.webp", alt: "Citroën C3 - vue latérale" },
      { src: "/images/C3 normal manuel diesel 2024.webp", alt: "Citroën C3 - vue latérale" }
    ],
    pricePerDay: 280,
    seats: 5,
    fuelType: "Diesel",
  ...
  },
  {
    ...
    model: "Kia Picanto 1.0 GDI 66 AMT",
    year: 2024,
    carImage: "/images/kia-picanto-bleu-front.webp",
    images: [
      { src: "/images/right-side-kia-bleu.webp", alt: "Kia Picanto - vue avant", isPrimary: true },
      { src: "/images/back-kia-bleu.webp", alt: "Kia Picanto - intérieur" },
      { src: "/images/backk-kia-bleu.webp", alt: "Kia Picanto - vue latérale" }
    ],
    pricePerDay: 320,
    seats: 5,
    fuelType: "Essence",
  ...
  },
  {
    ...
    model: "Kia Picanto 1.0 GDI 66 AMT",
    year: 2024,
    carImage: "/images/front-kia-greey.webp",
    images: [
      { src: "/images/front-kia-greey.webp", alt: "Kia Picanto - vue avant", isPrimary: true },
      { src: "/images/back-gia-grey.webp", alt: "Kia Picanto - intérieur" },
      { src: "/images/inside-kia-greey.webp", alt: "Kia Picanto - vue latérale" },
      { src: "/images/right-side-kia-greey.webp", alt: "Kia Picanto - vue latérale" }
    ],
    pricePerDay: 320,
    seats: 5,
    fuelType: "Essence",
