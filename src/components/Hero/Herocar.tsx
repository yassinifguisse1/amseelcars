"use client"
import type {} from '@react-three/fiber'          // forces the augmentation to load
import * as THREE from 'three'
import { useLayoutEffect, useRef, useState } from 'react'
import { Canvas, applyProps, createRoot, useFrame } from '@react-three/fiber'
...
// type PorscheProps = Omit<JSX.IntrinsicElements['primitive'], 'object'>
...
//   const { scene, nodes, materials } =
//     useGLTF('/911-transformed.glb') as unknown as GLTFResult
...
//   useFrame((_, delta) => (group.current.position.z += delta * 10) > 20 && (group.current.position.z = -60))
//   return (
//     <>
//       {/* Ceiling */}
